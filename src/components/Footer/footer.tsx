export default function Footer() {
    return (
        <footer className='fixed h-[50px] w-full flex flex-row flex-wrap justify-center items-center font-semibold uppercase bg-[#0F0F0F] bottom-0 whitespace-break-spaces font-montserrat'>
            ...
            <span> · </span>
            <span>{process.env.NODE_ENV === "production" ? (<>clone <a href="https://github.com/DeadCodeGames/ReactTSTWBoilerplate4GHPages">here</a> :3</>) : "Running in DEVELOPMENT MODE"}</span>
        </footer>
    )
}